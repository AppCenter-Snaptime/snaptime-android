...
public val BottomAppBar.ActiveMain: ImageVector
    get() {
        if (_activeMain != null) {
            return _activeMain!!
        }
        _activeMain = Builder(name = "ActiveMain", defaultWidth = 20.0.dp, defaultHeight = 17.0.dp,
...
private var _activeMain: ImageVector? = null
