...
public val BottomAppBar.InactiveRecommend: ImageVector
    get() {
        if (_inactiveRecommend != null) {
            return _inactiveRecommend!!
        }
        _inactiveRecommend = Builder(name = "InactiveRecommend", defaultWidth = 20.0.dp,
                defaultHeight = 19.0.dp, viewportWidth = 20.0f, viewportHeight = 19.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF3C3C3C)),
...
private var _inactiveRecommend: ImageVector? = null
