...
public val BottomAppBar.ActiveCommunity: ImageVector
    get() {
        if (_activeCommunity != null) {
            return _activeCommunity!!
        }
        _activeCommunity = Builder(name = "ActiveCommunity", defaultWidth = 18.0.dp, defaultHeight =
...
private var _activeCommunity: ImageVector? = null
