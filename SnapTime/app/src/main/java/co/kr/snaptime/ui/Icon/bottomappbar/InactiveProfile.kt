...
public val BottomAppBar.InactiveProfile: ImageVector
    get() {
        if (_inactiveProfile != null) {
            return _inactiveProfile!!
        }
        _inactiveProfile = Builder(name = "InactiveProfile", defaultWidth = 22.0.dp, defaultHeight =
...
private var _inactiveProfile: ImageVector? = null
