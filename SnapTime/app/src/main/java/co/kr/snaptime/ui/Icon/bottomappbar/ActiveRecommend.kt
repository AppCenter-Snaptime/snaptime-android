...
public val BottomAppBar.ActiveRecommend: ImageVector
    get() {
        if (_activeRecommend != null) {
            return _activeRecommend!!
        }
        _activeRecommend = Builder(name = "ActiveRecommend", defaultWidth = 20.0.dp, defaultHeight =
                19.0.dp, viewportWidth = 20.0f, viewportHeight = 19.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFFA4CEFF)),
...
private var _activeRecommend: ImageVector? = null
